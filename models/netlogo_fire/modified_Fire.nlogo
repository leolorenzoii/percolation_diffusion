globals [
  ...
  reached-end     ;; if the fire reached the end
]
...
to go
  ...
  [   ask fires
    [ ask neighbors4 with [pcolor = green]
        [ ignite ]
      set breed embers ] ]
  ;; check if fire reaches the end
  if any? embers with [(pxcor = max-pxcor) and (pcolor < red - 3.5)]
  [ set reached-end 1 ]
...
; Extended by Leodegario Lorenzo II, 08 November 2021
@#$#@#$#@
GRAPHICS-WINDOW
271
16
